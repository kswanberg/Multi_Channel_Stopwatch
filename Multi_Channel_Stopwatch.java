...
public class Multi_Channel_Stopwatch_final_clean_November2014 extends PApplet {
...
{   
   ...
   { 
    ...
    fill(0xffFF0000); 
    stroke(0xffFF0000); 
    text("key 1 pressed!", width/2, height/2.6f); 
    } 
    ...
    fill(0xff0FB300); 
    stroke(0xff0FB300); 
    text("key 2 pressed!", width/2, height/2.6f); 
    } 
    ...
    fill(0xff0715cd);
    stroke(0xff0715cd); 
    text("key 3 pressed!", width/2, height/2.6f); 
    }
    ...
    fill(0xffFF00FB);
    stroke(0xffFF00FB); 
    text("key 4 pressed!", width/2, height/2.6f);
    }
    ...
    fill(0xffFFBB00);
    stroke(0xffFFBB00); 
    text("key 5 pressed!", width/2, height/2.6f);
    }
    else 
    {
    ellipse(300,100,100,100); 
...
public void keyReleased()
{
  ...
  println( "key 1 presses: " + ((arraylength_1-1)*0.5f));
  }
  else if (key == '2' && startstop == 1 && pause == 0)
  {
  keyIndex = 0;
  ...
  println("key 2 presses: " + ((arraylength_2-1)*0.5f));
  }
  else if (key == '3' && startstop == 1 && pause == 0)
  {
  keyIndex = 0;
  ...
  println("key 3 presses: " + ((arraylength_3-1)*0.5f));
  }
  else if (key == '4' && startstop == 1 && pause == 0)
  {
  keyIndex = 0;
  ...
  println("key 4 presses: " + ((arraylength_4-1)*0.5f));
  }
  else if (key == '5' && startstop == 1 && pause == 0)
  {
  keyIndex = 0;
  ...
  println("key 5 presses: " + ((arraylength_5-1)*0.5f));
  }
  else
  {
  keyIndex = 0;
...
public void export()
{
  output = createWriter("data.txt");
    ...
    output.println("Key 1 Press Number: " + (arraylength_1-1)*0.5f); 
    output.println(' ');
    ...
    output.println("Key 2 Press Number: " + (arraylength_2-1)*0.5f); 
    output.println(' ');
    ...
    output.println("Key 3 Press Number: " + (arraylength_3-1)*0.5f); 
    output.println(' ');
    ...
    output.println("Key 4 Press Number: " + (arraylength_4-1)*0.5f); 
    output.println(' ');
    ...
    output.println("Key 5 Press Number: " + (arraylength_5-1)*0.5f); 
    output.println(' ');
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Multi_Channel_Stopwatch_final_clean_November2014" };
    if (passedArgs != null) {
